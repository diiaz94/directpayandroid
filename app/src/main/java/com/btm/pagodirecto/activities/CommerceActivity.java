...
public class CommerceActivity extends BaseActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_commerce_tab1, container, false);
            return rootView;
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    Tab1NearBy tab1 =  new Tab1NearBy();
                    return tab1;
                case 1:
                    Tab2CommerceList tab2 = new Tab2CommerceList();
                    return tab2;
                case 2:
                    Tab3FavCommerce tab3 = new Tab3FavCommerce();
                    return tab3;
                default:
                    return null;
            }
